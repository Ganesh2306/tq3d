console.log('Q3d_Appplication V8.0 27-02-2026');
...
if (urlstring.includes(searchStringUrl)) {
    ...
    $.ajax({
        ...
        window.loadProductsByFabricResponseDto = r.loadProductsByFabricResponseDto;
...
$("body").on("click", "#appendFabricList .fabric_thumb_wrap", function () {
        const fabricId = $(this).find('.fabric_img').attr('id');
...
const DOMAIN_NAME = "q3d";
const SECRET_KEY = "K3qMUrfKUQYznidC"; 
...
const TryonScripts = ["https://plugin.dam3d.in/tryon/v1/tdsInit.js?v.4.0"];
