...
//     //     $('#common_notification').text('Please login to use Tryon').show();
...
//     // if (!$("#root div").hasClass("tryon_page")) {
//     //     $("#root").append(loadTryonUi());
//     // }

//     // 🔹 LOAD SDK FIRST
//     loadScripts(TryonScripts)
//         .then(() => {

//             if (!window.TryOnSDK) {
//                 stopBuffer();
//                 sweetalert_error("TryOn SDK failed to load");
//                 return;
//             }

//             // 🔹 AUTHENTICATE / INIT SDK
//             TryOnSDK.init({
//                 containerId: "tryonModal",
//                 domainName: "https://fab3d.in",
//                 secretKey: "SK-99MRKQRRS9",
//                 apiKey: "cus_PKW6JyhY8BM9R9NcNlnv7g"
//             });
...
//             const lastdrapeDesignData = window.lastFabricInfo;

//             // if (lastdrapeDesignData) {
//             //     startTryon(
//             //         q3d_Plugin,
//             //         lastdrapeDesignData.t_fabUrl,
//             //         parseFloat(lastdrapeDesignData.width),
//             //         parseFloat(lastdrapeDesignData.height),
//             //         lastdrapeDesignData.designCode,
//             //         clickCounter
//             //     );
//             // } else {
//             //     stopBuffer();
...
//             sweetalert_error("Unable to load TryOn service");
//         });
// });
...
$("body").on("click", "#tryonbt", async function () {
   ...
   startBuffer();
    ...
    // Load TryOn UI
    // If tryon-frame does not exist, append it
if ($("#root .tryon-frame").length === 0) {
    $("#root").append(loadTryonUi());
}

// Hide everything inside #root
// $("#root").children().hide();

// // Show ONLY tryon-frame
//$("#root .tryon-frame").show();
$("#root .tryon-frame")
    .show()
...
//const TryonScripts = ["https://plugin.dam3d.in/tryon/v1/TDS-Tryon.min.js?v.3.0"];
 const TryonScripts = ["https://plugin.dam3d.in/tryon/v1/tdsInit.js"]; // https://linux.q3d.in/TryOn/Q3dJs
//const TryonScripts = ["https://linux.q3d.in/TryOn/Q3dJs?v=1.1"];
// const TryonScripts = ["http://172.16.10.141:3005/Q3d_Plugin/authJs"];
...
// desktop fabric thumb fullview loadmore button  akash
// $("body").on("click", ".load_more", function (event) {
//     checkScrollBarPos(function(){
//       hasHScrollBar();
//     })
//   });

//desktop fabric button
...
$(document).ready(function () {
    $("body").on("click", "#btn_STYLEME", function () {
        stopBuffer();
